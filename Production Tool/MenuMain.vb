...
Public Class MenuMain
	...
	Private Sub B_CreateALPHAFile_Click() Handles B_CreateALPHAFile.Click
		OpenForm(CreateALPHAFile)
	End Sub

	Private Sub B_OptimizeMags_Click() Handles B_OptimizeMags.Click
		OpenForm(OptimizeMags)
	End Sub
	...
	Private Sub Button_VerifyAssembly_Click() Handles Button_VerifyAssembly.Click
		OpenForm(VerifyAssembly)
	End Sub

	Private Sub CompareSplit_Button_Click() Handles CompareSplit_Button.Click
		OpenForm(CompareSplit)
	End Sub
