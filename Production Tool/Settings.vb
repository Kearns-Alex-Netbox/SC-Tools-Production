...
Public Class Settings
	...
	Public Sub OpenLocation(ByVal root As String, ByVal windowTitle As String, ByRef finalLocation As String, ByVal filter As String, ByVal isFolder As Boolean)
